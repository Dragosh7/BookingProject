    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http
                .authorizeHttpRequests(authConfig -> {
                    ...
                    authConfig.requestMatchers(HttpMethod.GET, "/categories", "/tags", "/places", "/places/detail").permitAll();
                    authConfig.requestMatchers(HttpMethod.POST, "/categories", "/tags", "/places", "/places/detail").permitAll();
                    ...
                    authConfig.requestMatchers(HttpMethod.GET, "/admin/places", "/admin/places/create", "/admin/places/delete", "/admin/places/add-tag?placeID=*", "/admin/places/update").hasAnyAuthority("ADMIN", "USER");
                    authConfig.requestMatchers(HttpMethod.POST, "/admin/places", "/admin/places/create", "/admin/places/delete", "/admin/places/add-tag?placeID=*", "/admin/places/update/**").hasAnyAuthority("ADMIN", "USER");
                    authConfig.requestMatchers(HttpMethod.PUT, "/admin/places", "/admin/places/create", "/admin/places/delete", "/admin/places/add-tag?placeID=*", "/admin/places/update/**").hasAnyAuthority("ADMIN", "USER");
